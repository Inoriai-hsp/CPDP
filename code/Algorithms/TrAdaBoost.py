...
class TrAdaBoost(object):
    def __init__(self, trans_S, label_S, trans_A, label_A, test, label_test, initWeight, clf, N=20):
                 # clf='RF', RFn_estimators=10, criterion='gini',
                 # max_features='auto',
                 # SVCkernel='poly', C=1, degree=3, coef0=1, SVCgamma=1, Boostnestimator=50, BoostLearnrate=1,
                 # NBType='gaussian', CARTspliter='best', min_sample=2,
