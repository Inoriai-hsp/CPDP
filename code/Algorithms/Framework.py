...
class cpdp(object):
    ...
    def update_param(self, key, value):
        ...
        if key == 'pvalue':
            self.pvalue = value
        if key == 'QuantifyType':
            self.QuntifyType = value

        # DTB
        if key == 'DTBneighbors':
            self.DTBneighbors = value
        if key == 'DTBT':
            self.DTBT = value
        ...
        if key == 'DSBFtopk':
            self.DSBFtopk = value
        if key == 'DSBFneighbors':
            self.DSBFneighbor = value
        ...
        # peter
        if key == 'eachCluster':
            self.eachCluster = value
        # Bruak
        if key == 'n_neighbors':
            self.Barukneighbors = value
        # DS
        if key == 'DStopn':
            self.DStopn = value
        if key == 'DSfss':
        ...
        if key == 'RFmin_samples_split':
            self.RFmin_samples = value
        # Boost
        if key == 'Boostnestimator':
            self.Boostne = value
        if key == 'BoostLearnrate':
            self.BoostLearnrate = value
        # NN
        if key == 'NNactive':
            self.NNactive = value
        if key == 'NNalpha':
            self.NNalpha = value
        if key == 'NNmaxiter':
            self.NNmaxiter = value
        # NB
        if key == 'NBType':
            self.NBType = value
        # CART
        if key == 'CARTsplitter':
            self.CARTsplitter = value
        # Ridge
        if key == 'Ridgealpha':
            self.Ridgealpha = value
        if key == 'Ridgenormalize':
            self.Ridgenormalize = value
